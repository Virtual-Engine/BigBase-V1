...
namespace Big
{
	...
	namespace HUD
	{
		//inline void SET_TEXT_COLOUR(int red, int green, int blue, int alpha) { invoke<int>(0xBE6B23FFA53FB442, red, green, blue, alpha); } // 0xBE6B23FFA53FB442 0xE54DD2C8 b323
	...
	namespace MISC
	{
		static void SET_BEAST_JUMP_THIS_FRAME(Player player) { invoke<int>(0x438822C279B73B93, player); } // 0x438822C279B73B93  b573
