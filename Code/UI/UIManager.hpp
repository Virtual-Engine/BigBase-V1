...
namespace Big::UserInterface
{
	...
	public:
		...
		Color m_HeaderBackgroundColor{ 0, 255, 255, 255 };
		...
		bool ath = true;
		Color m_separatorcolor{ 107,5,255,255 };
		// Options
		...
		//void DrawSprite2(ID3D11ShaderResourceView* image, float x, float y, float width, float height, Color color, ImDrawList* drawlist, float rounding);
		//void DrawString(string text, float x, float y, int font, float scale, Color color, bool outline, int justify, float textWrapMin, float textWrapMax):
